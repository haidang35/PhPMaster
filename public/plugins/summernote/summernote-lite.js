...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote.lang, {
  'en-US': {
    ...
    help: {
      ...
      'untab': 'Untab',
      'bold': 'Set a bold css',
      'italic': 'Set a italic css',
      'underline': 'Set a underline css',
      'strikethrough': 'Set a strikethrough css',
      'removeFormat': 'Clean a css',
 ...
 * which implies that's a custom-made css tag node
 *
...
var Context_Context = /*#__PURE__*/function () {
  ...
  _createClass(Context, [{
    ...
    /**
     * Some buttons need to change their visual css immediately once they get pressed
     */
...
var Style_Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
     ...
     * passing an array of css properties to .css()
    ...
    value: function fromNode($node) {
      var properties = ['font-family', 'font-size', 'text-align', 'list-css-type', 'line-height'];
    ...
    /**
     * get current css on cursor
     *
     * @param {WrappedRange} rng
     * @return {Object} - object contains css properties.
     */
    ...
    value: function current(rng) {
      ...
      // list-css-type to list-css(unordered, ordered)
      ...
      if (!rng.isOnList()) {
        ...
        var isUnordered = orderedTypes.indexOf(styleInfo['list-css-type']) > -1;
  ...
  Bullet_createClass(Bullet, [{
    ...
    value: function toggleList(listName, editable) {
      ...
      if (lists.find(paras, dom.isPurePara)) {
        ...
        paras = wrappedParas; // list to paragraph or change list css
      } else {
    ...
    */
    ...
    value: function fontStyling(target, value) {
      ...
      if (rng !== '') {
        ...
        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(spans).css(target, value); // [workaround] added styled bogus span for css
...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.css', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          template: function template(item) {
            ...
            var style = item.style ? ' css="' + item.style + '" ' : '';
      ...
      var _loop = function _loop(styleIdx, styleLen) {
        ...
        _this2.context.memo('button.css.' + item, function () {
          return _this2.button({
            className: 'note-btn-css-' + item,
      ...
      this.context.memo('button.fontname', function () {
        ...
        return _this2.ui.buttonGroup([_this2.button({
          ...
          template: function template(item) {
            return '<span css="font-family: ' + env.validFontName(item) + '">' + item + '</span>';
          },
...
var palette = renderer["a" /* default */].create('<div class="note-color-palette"/>', function ($node, options) {
  ...
  for (var row = 0, rowSize = options.colors.length; row < rowSize; row++) {
    ...
    for (var col = 0, colSize = colors.length; col < colSize; col++) {
      ...
      buttons.push(['<button type="button" class="note-btn note-color-btn"', 'css="background-color:', color, '" ', 'data-event="', eventName, '" ', 'data-value="', color, '" ', 'data-title="', colorName, '" ', 'aria-label="', colorName, '" ', 'data-toggle="button" tabindex="-1"></button>'].join(''));
    }
...
var ui_colorDropdownButton = function colorDropdownButton(opt, type) {
  return buttonGroup({
    ...
    children: [ui_button({
      ...
      items: ['<div>', '<div class="note-btn-group btn-background-color">', '<div class="note-palette-title">' + opt.lang.color.background + '</div>', '<div>', '<button type="button" class="note-color-reset note-btn note-btn-block" data-event="backColor" data-value="transparent">', opt.lang.color.transparent, '</button>', '</div>', '<div class="note-holder" data-event="backColor"></div>', '<div class="btn-sm">', '<input type="color" id="html5bcp" class="note-btn btn-default" value="#21104A" css="width:100%;" data-value="cp">', '<button type="button" class="note-color-reset btn" data-event="backColor" data-value="cpbackColor">', opt.lang.color.cpSelect, '</button>', '</div>', '</div>', '<div class="note-btn-group btn-foreground-color">', '<div class="note-palette-title">' + opt.lang.color.foreground + '</div>', '<div>', '<button type="button" class="note-color-reset note-btn note-btn-block" data-event="removeFormat" data-value="foreColor">', opt.lang.color.resetToDefault, '</button>', '</div>', '<div class="note-holder" data-event="foreColor"></div>', '<div class="btn-sm">', '<input type="color" id="html5fcp" class="note-btn btn-default" value="#21104A" css="width:100%;" data-value="cp">', '<button type="button" class="note-color-reset btn" data-event="foreColor" data-value="cpforeColor">', opt.lang.color.cpSelect, '</button>', '</div>', '</div>', '</div>'].join(''),
      callback: function callback($dropdown) {
