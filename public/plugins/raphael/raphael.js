...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
    ...
    setFillAndStroke = function (o, params) {
        // o.paper.canvas.css.display = "none";
        o.attrs = o.attrs || {};
        var node = o.node,
            a = o.attrs,
            s = node.style,
        ...
        if (res.type == "text") {
            ...
            // res.paper.canvas.css.display = "none";
            res.X = a.x;
            res.Y = a.y + res.H / 2;
        ...
        // res.paper.canvas.css.display = E;
    },
    ...
    elproto.attr = function (name, value) {
        ...
        if (params) {
            ...
            // this.paper.canvas.css.display = "none";
            if (params.text && this.type == "text") {
                this.textpath.string = params.text;
            }
            setFillAndStroke(this, params);
            // this.paper.canvas.css.display = E;
        }
        return this;
    };
    elproto.toFront = function () {
