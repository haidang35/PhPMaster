  ...
  */
  ...
  return {
    ...
    token: function(stream, state) {
      ...
      if (hooks.token) {
        // Call hook, with an optional return value of a css to override verilog styling.
  ...
  var tlvIdentifierStyle = {
    ...
    "<<": "tag",
    "<>": "tag",
    "#": "tag",  // Need to choose a css for this.
    "^": "attribute",
    "^^": "attribute",
    "^!": "attribute",
    "*": "variable-2",
  ...
  // Returns a css specific to the scope at the given indentation column.
  ...
  CodeMirror.defineMIME("text/x-tlv", {
    ...
    hooks: {
      ...
      // Return undefined for verilog tokenizing, or css for TLV token (null not used).
      ...
      token: function(stream, state) {
        ...
        if (state.tlvCodeActive) {
          ...
          if (style !== undefined) {
            ...
            // Indentation
            style = // make this css distinct from the previous one to prevent
